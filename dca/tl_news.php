...
array_insert($GLOBALS['TL_DCA']['tl_module']['palettes']['__selector__'],0,'news_slideshow');

$GLOBALS['TL_DCA']['tl_news']['subpalettes']['addImage'] = 'news_slideshow,' . $GLOBALS['TL_DCA']['tl_news']['subpalettes']['addImage'];
